...
class ArchetypalAnalysis():
    ...
    def plot_simplex(self, alfa, plot_args = {}, grid_on = True):
        ...
        # handles = [plt.Line2D([0], [0], marker='o', color='w', markersize=10, markerfacecolor=color) for color in region_colors]
    ...
    def plot_radar_profile(self, feature_cols = None, Title = 'Radar plot of archetype profiles'):
        ...
        # angles = np.concatenate((angles, [angles[0]]))  SAHITHI EDIT - commented
        ...
        for i in range(self.n_archetypes):
            ...
            # x_close = np.concatenate((x_close, [x_close[0]])) SAHITHI EDIT - commented          
        ...
        # ax.legend(legend, bbox)
        ax.legend(legend, loc='upper left', bbox_to_anchor=(1.1, 1))  # Move legend to the right
